---
title: Youtube Downloader - youtube-dl
description: Youtube Downloader - youtube-dl
header: Youtube Downloader - youtube-dl
categories: Linux
---
...
# EXAMPLES
###	 Contoh pada terminal [ berlaku untuk single video dan playlist video ]
###	 1. Melihat Kualitas vidio yang tersedia dan mendownload

<b>1. Command : $</b> `youtube-dl -F https://www.youtube.com/watch?v=BlLFswfu9CY` <br />
<b>2. Command : $</b> `youtube-dl -f 22 https://www.youtube.com/watch?v=BlLFswfu9CY`

###	 2. Download video terbaik dan dengan title dan id menjadi nama_file

<b>Command : $</b> `youtube-dl -t -f bestvideo+bestaudio "https://www.youtube.com/watch?v=BlLFswfu9CY"`

###	 3. Download video terbaik dan dengan title menjadi nama_file

<b>Command : $</b> `youtube-dl -o '%(title)s.%(ext)s' -f bestvideo+bestaudio https://www.youtube.com/watch?v=BlLFswfu9CY`

###	 4. MIX Download Video terbaik + Audio terbaik I

<b>1. Command : $</b> `youtube-dl -F https://www.youtube.com/watch?v=BlLFswfu9CY` <br />
<b>2. Command : $</b> `youtube-dl -f 135+140 https://www.youtube.com/watch?v=BlLFswfu9CY`

###	 5. MIX Download Video terbaik + Audio terbaik dan save title menjadi nama_file I

<b>Command : $</b> `youtube-dl -o '%(title)s.%(ext)s' -f 137+140 https://www.youtube.com/watch?v=BlLFswfu9CY`

###	 6. MIX Download Video terbaik + Audio terbaik dan save title menjadi nama_file

<b>Command : $</b> `youtube-dl -o '%(title)s.%(ext)s' -f bestvideo+bestaudio https://www.youtube.com/watch?v=BlLFswfu9CY`

###	 7. MIX Download Video terbaik + Audio terbaik + Pilih Extenstion II

<b>Command : $</b> `youtube-dl -f 'bestvideo[ext=mp4]+bestaudio[ext=m4a]/mp4' https://www.youtube.com/watch?v=BlLFswfu9CY`

###	 8. MIX Download Video terbaik + Audio terbaik + Pilih Extenstion dan save title menjadi nama_file II

<b>Command : $</b> `youtube-dl -o '%(title)s.%(ext)s' -f 'bestvideo[ext=mp4]+bestaudio[ext=m4a]/mp4' https://www.youtube.com/watch?v=BlLFswfu9CY`

###  9. Overwrite dan Continue [ secara default terhandle ]

<b>Command : $</b> `youtube-dl -wc -o '%(title)s.%(ext)s' -f 'bestvideo[ext=mp4]+bestaudio[ext=m4a]/mp4' https://www.youtube.com/watch?v=BlLFswfu9CY`	
...
<hr />
### Sumber : 
* [https://github.com/rg3/youtube-dl/blob/master/README.md](https://github.com/rg3/youtube-dl/blob/master/README.md){:target="_blank"}
* [http://www.webupd8.org/2014/02/video-downloader-youtube-dl-gets.html](http://www.webupd8.org/2014/02/video-downloader-youtube-dl-gets.html){:target="_blank"}
* [https://unix.stackexchange.com/questions/272868/download-only-format-mp4-on-youtube-dl](https://unix.stackexchange.com/questions/272868/download-only-format-mp4-on-youtube-dl){:target="_blank"}
